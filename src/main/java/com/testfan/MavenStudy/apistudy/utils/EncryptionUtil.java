...
public class EncryptionUtil 
{
    ...
    public static void main( String[] args ) throws Exception {
        ...
        System.out.println(md5("123456"));//md5 的加密
    	String aesEncode = aesEncode("abcdefg", "1234567891234567");//加密
    	System.out.println(aesEncode);

    	String aesDecode = aesDecode("89Dw8PpTrUSMdh3oJ7U4Zw==", "1234567891234567");//解密
