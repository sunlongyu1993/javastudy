...
public abstract class RedPacketFrame extends JFrame {
    ...
    private static JLabel input_bg_label = new JLabel((new ImageIcon("\\javaTest\\src\\red\\open1.jpg")));
    ...
    private static JLabel open_label = new JLabel(new ImageIcon("\\javaTest\\src\\red\\open.gif"));
    private static JLabel open_bg_label = new JLabel(new ImageIcon("\\javaTest\\src\\red\\open2.jpg"));
    ...
    private static JLabel show_bg_label = new JLabel(new ImageIcon("\\javaTest\\src\\red\\money.jpg"));
